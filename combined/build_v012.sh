...
"$AAPT" dump badging Darkroom-v0.1.2.apk > apk-badging-v012.txt
grep -q "package: name='it.darkroom.darkroom' versionCode='3' versionName='0.1.2'" apk-badging-v012.txt
grep -q "launchable-activity: name='it.darkroom.timer.home.HomeActivity'" apk-badging-v012.txt
unzip -l Darkroom-v0.1.2.apk > apk-listing-v012.txt
grep -q 'assets/mdc_full.sqlite' apk-listing-v012.txt
grep -Eq 'res/drawable-nodpi(-v4)?/home_vintage.webp' apk-listing-v012.txt
