...
public final class JpegCardRenderer {
    ...
    public static Bitmap render(LogEntry e, String version) {
        ...
        if (!sequence.isEmpty() || recipe.hasBase()) drawPrintRecipe(c, sequence, recipe, e.exposureMs, noteTop + 126f);
        ...
        if (TimingMath.isFStop(e.exposureMethod) || TimingMath.isFStop(e.testMethod)) {
            ...
            badgeFill.setColor(Color.rgb(201, 157, 70));
    ...
    private static void drawPrintRecipe(Canvas c, PrintSequence sequence, ExposureRecipe recipe, int baseMs, float top) {
