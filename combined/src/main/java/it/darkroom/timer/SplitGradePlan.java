...
public final class SplitGradePlan {
    ...
    public String softPrompt() { return "Azzera il magenta e imposta giallo " + softYellow + ". Poi premi il pulsante."; }
    public String hardPrompt() { return "Azzera il giallo e imposta magenta " + hardMagenta + ". Poi premi il pulsante."; }
