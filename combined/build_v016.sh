...
s=s.replace('Darkroom-v0.1.5','Darkroom-v0.1.6').replace('versionCode="6"','versionCode="7"').replace("versionCode 6","versionCode 7").replace("versionCode='6'","versionCode='7'").replace('versionName="0.1.5"','versionName="0.1.6").replace("versionName '0.1.5'","versionName '0.1.6'").replace("versionName='0.1.5'","versionName='0.1.6'")
