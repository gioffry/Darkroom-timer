...
s=s.replace("versionCode 6","versionCode 7")
s=s.replace("versionCode='6'","versionCode='7'")
s=s.replace('versionName="0.1.5"','versionName="0.1.6"')
s=s.replace("versionName '0.1.5'","versionName '0.1.6'")
s=s.replace("versionName='0.1.5'","versionName='0.1.6'")
s=s.replace("# Versione Darkroom 0.1.5 / versionCode 6.","# Versione Darkroom 0.1.6 / versionCode 7.")
...
# Validation metadata for this release.
