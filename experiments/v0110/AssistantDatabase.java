...
public final class AssistantDatabase extends SQLiteOpenHelper {
    ...
    @Override public void onCreate(SQLiteDatabase db){
        ...
        createR5R6(db); db.execSQL(AssistantDataSchema.CREATE_FAVORITE_INDEX); db.execSQL(AssistantDataSchema.CREATE_LOG_COMBO_INDEX); db.execSQL(AssistantDataSchema.CREATE_ORIGINAL_IMMUTABLE_TRIGGER);
    }
