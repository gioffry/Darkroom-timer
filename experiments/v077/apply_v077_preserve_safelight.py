...
checks={
    ...
    service:['captureAndDimSafelightForCycle()','stato manuale luce rossa rispettato','SAFELIGHT era già OFF • nessun comando','SAFELIGHT ripristinata ON perché era ON prima del ciclo']
}
