...
must('allowManual=false;' in search and 'INSERISCI MANUALMENTE' not in search,'manual creation disabled and removed')
...
must('extractDilutions' in parser and 'Pattern.compile("(?i)(?:1' in parser,'documented dilution extraction')
