...
public final class PaperChemistryActivity extends Activity {
    ...
    private String originLabel(AssistantDatabase.ChemicalItem x){String base=AssistantDatabase.SOURCE_CATALOG.equals(x.sourceType)?"DATI DOCUMENTATI · "+emptyOr(x.sourceName,"fonte catalogo"):"DATI PERSONALI · inseriti dall'utente";
