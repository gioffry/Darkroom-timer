...
public final class BackupEngine {
    ...
    private static final String[] TABLES={
            ...
            "personal_equipment","personal_tanks","assistant_sessions","paper_chemistry_sessions"
    };
    private static final String[] PREFS={"ui","assistant_operational","assistant_settings","paper_chemistry_session","print_log"};
    ...
    public static void restore(Context c,String json,String mode) throws Exception {
        ...
        AssistantDatabase helper=new AssistantDatabase(c);SQLiteDatabase db=helper.getWritableDatabase();boolean prefsChanged=false;db.beginTransaction();try{
            if(MODE_REPLACE.equals(mode)){for(String table:new String[]{"chemical_usage","personal_tanks","personal_equipment","chemical_inventory","development_logs","personal_recipes","assistant_sessions","paper_chemistry_sessions"})db.delete(table,null,null);}
